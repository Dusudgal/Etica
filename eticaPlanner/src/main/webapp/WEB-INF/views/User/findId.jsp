...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/Resources/css/findIdStyle.css' />" type="text/css">
...
<div class="container">
    <div class="form-wrapper">
        <h2><a href="/user/sign-up-view">아이디 찾기</a></h2>
        <input type="text" name="email" placeholder="이메일을 입력하세요" required>
        <button id="findUserIdButton" class="btn btn-primary">아이디 찾기</button>
    </div>
</div>
